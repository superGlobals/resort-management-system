      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="templateux-navbar-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="">Entrance & Cottages</a></li>
        ...
        <div class="container">
            <div class="row rooms-hero-inner justify-content-center align-items-center">
                <div class="col-md-10 text-center" data-aos="fade-up">
                    <h1 class="heading text-white"><?= esc(ucwords($single_room->room_name)) ?></h1>
                </div>
            </div>
        </div>
      </section>
            ...
            <div class="col-md-5 mt-2">
                ...
                <div class="mt-3 mb-2 text-center">
                    <?php if(session()->has('customer_id')): ?>
                        <a href="" class="btn btn-primary" data-bs-toggle="modal">Checkin Now</a>
                    <?php else: ?>
                        <a href="<?= base_url('Customer/login') ?>" class="btn btn-primary" data-bs-toggle="modal">Checkin Now</a>
                    <?php endif; ?>
                </div>
            </div>
            <div class="col-md-7">
