...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">List of room to checkin today </h4>
        </div>
    </div>
</div>
                        ...
                        <tbody> 
                            ...
                            <?php foreach($checkin as $row): ?>
                                <tr>
                                    ...
                                    <td><?= $row->payment_status == '' ? 'Not Fully Paid' : 'Fully Paid' ?></td>
                                    <td>
                                        
                                        <a href="#checkin<?= $row->transaction_id ?>" class="confirm_del btn btn-success btn-sm" data-bs-toggle="modal"><i class="fa-solid fa-check"></i> Checkin</button>
                                    </td>
                                </tr>
                                <?php require 'room_number_modal.php' ?>
