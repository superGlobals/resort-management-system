...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="<?= base_url('Room-number/store') ?>" method="POST">
                <?= csrf_field() ?>
                <div class="row">
                    <div class="mb-3">
                        <label for="room_number" class="form-label">Room Number</label>
                        <input type="text" name="room_number" value="<?= set_value('room_number') ?>" class="form-control" placeholder="Room Number here...">
