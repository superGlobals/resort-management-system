...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">List of accepted events & place booking </h4>
        </div>
    </div>
</div>
                        ...
                        <tbody> 
                            <?php foreach($accepted as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($row->date_book == date('Y-m-d')): ?>
                                            <a href="<?=base_url()?>/mark-fully-paid/<?= $row->transaction_id ?>" class="btn btn-success btn-sm"><i class="fa-solid fa-marker"></i> Mark as fully paid</a>
                                        <?php endif ?>
