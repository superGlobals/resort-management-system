  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url() ?>/reject-event-booking/<?= $row->transaction_id ?>" method="POST">
        <?= csrf_field() ?>
            <div class="mb-3">
                <label for="">Include a message explaining why you cancelled this event booking. </label>
