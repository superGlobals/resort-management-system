...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">List of pending events a& place booking </h4>
        </div>
    </div>
</div>
                        ...
                        <tbody> 
                            <?php foreach($pending as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=base_url()?>/accept-event-booking/<?= $row->transaction_id ?>" class="btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i> Accept</a>
                                        ...
                                        <a href="<?=base_url()?>/resubmit-gcash-ref-no/<?= $row->transaction_id ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-rotate-right"></i> Re-submit Gcash Ref No.</a>
                                    </td>
