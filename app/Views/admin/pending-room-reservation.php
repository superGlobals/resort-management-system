                ...
                <div class="table-responsive">
                    <table id="alternative-page-datatable" class="table dt-responsive nowrap">
                        ...
                        <tbody> 
                            ...
                            <?php foreach($pending_rooms as $row): ?>
                                <tr>
                                    ...
                                    <td><?= esc(ucwords($row->total_bill)) ?></td>
                                    <td><?= esc($row->payment_deposit) ?></td>
                                    <td><?= esc($row->gcash_reference_number) ?></td>
                                    <td>
                                        <a href="<?=base_url()?>/accept-room-reservation/<?= $row->transaction_id ?>" class="btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i> Accept</a>
                                        <a href="#reject<?= $row->transaction_id ?>" class="confirm_del btn btn-danger btn-sm" data-bs-toggle="modal"><i class="fa-solid fa-trash"></i> Cancel</a>
                                        <a href="<?=base_url()?>/resubmit-gcash-ref-no-room/<?= $row->transaction_id ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-rotate-right"></i> Re-submit Gcash Ref No.</a>
