            ...
            <form action="<?= base_url() ?>/Events/update/<?= $event->id ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="text" name="events_name" value="<?= set_value('events_name', $event->events_name) ?>" class="form-control" placeholder="Event Name here...">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_capacity" value="<?= set_value('max_capacity',  $event->max_capacity) ?>" class="form-control" placeholder="Enter max capacity">
                        <span class="text-danger text-sm"><?= isset($validation) ? show_error($validation, 'max_capacity') : '' ?></span>
                    </div>

                    <div class="mb-3">
                        <label for="rate" class="form-label">Rate</label>
                        <input type="number" name="rate" value="<?= set_value('rate',  $event->rate) ?>" class="form-control" placeholder="Enter Rate">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <img src="<?= base_url() ?>/uploads/<?= $event->images ?>" id="previewFile" width="100" height="100">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea id="editor" name="description"><?= set_value('description', $event->description) ?></textarea>
