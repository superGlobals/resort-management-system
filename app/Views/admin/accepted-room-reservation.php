...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">List of accepted rooms reservation </h4>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table id="alternative-page-datatable" class="table dt-responsive nowrap">
                        ...
                        <tbody> 
                            ...
                            <?php foreach($accepted_rooms as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($row->checkin == date('Y-m-d')): ?>
                                            <a href="#checkin<?= $row->transaction_id ?>" class="btn btn-success btn-sm" data-bs-toggle="modal"><i class="fa-solid fa-check"></i> Checkin</a>
                                        <?php endif ?>
                                    </td>
                                </tr>
                                <?php require 'modal/room_number_modal.php' ?>
                            <?php endforeach; ?>
