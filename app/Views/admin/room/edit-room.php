...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="<?= base_url() ?>/Room/update-room/<?= $room->id ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <input type="hidden" name="_method" value="PUT">
                <div class="row">
                    <div class="mb-3">
                        <label for="room_name" class="form-label">Room Name</label>
                        <input type="text" name="room_name" value="<?= set_value('room_name', $room->room_name) ?>" class="form-control" placeholder="Room Name here...">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="room_category" class="form-select">
                            <option value="<?= $room->category_id ?>"><?= ucwords($room->category_name) ?></option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="available_rooms" value="<?= set_value('available_rooms',  $room->available_rooms) ?>" class="form-control" placeholder="Please specify available rooms in this category...">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="rate_per_night" value="<?= set_value('rate_per_night', $room->rate_per_night) ?>" class="form-control" placeholder="Rate per night here...">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="room_status" class="form-select">
                            <option value="<?= $room->room_status ?>"><?= ucfirst($room->room_status) ?></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <img src="<?= base_url() ?>/uploads/<?= $room->room_image ?>" id="previewFile" width="100" height="100">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="room_description" class="form-label">Room Description</label>
                        <textarea id="editor" name="room_description"><?= set_value('room_description', $room->room_description) ?></textarea>
