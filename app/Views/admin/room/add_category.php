...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Add Room Category</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="<?= base_url('Room/store_room_category') ?>" method="POST">
                <?= csrf_field() ?>
                <div class="row">
                    <div class="mb-3">
                        <label for="category_name" class="form-label">Category Name</label>
                        <input type="text" name="category_name" value="<?= set_value('category_name') ?>" class="form-control" placeholder="Catgory Name here...">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_adults_capacity" value="<?= set_value('max_adults_capacity') ?>" class="form-control" placeholder="Adult Capacity here...">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_children_capacity" value="<?= set_value('max_children_capacity') ?>" class="form-control" placeholder="Children Capacity here...">
